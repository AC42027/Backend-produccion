...
# ── Consulta de estado de avisos ──────────────────────────────────────────────
#
# La consulta de estado de avisos (IW29) se realiza de forma DIRECTA a SAP
# via pyRFC (inspeccion/sap_pyrfc.py) usando las credenciales LDAP del usuario.
